<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'teste@valdeansouza.com';//Trocar e-mail aqui!
		public $senha = '1598753';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'smtp.titan.email'; //SERVIDOR SMTP DA HOSPEDAGEM
