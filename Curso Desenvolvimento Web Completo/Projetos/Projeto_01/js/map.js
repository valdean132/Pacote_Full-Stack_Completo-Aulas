...
var mapProp = {
	center:new google.maps.LatLng(-3.099870,-60.062610),
	zoom:14,
	scrollwheel: false,
	styles: [{
		stylers: [{
...
function addMarker(lat,long,icon,content,showInfoWindow,openInfoWindow){
	...
	*/
	...
	iwBackground.children(':nth-child(2)').css({'background' : 'rgb(255,255,255)'}).css({'border-radius':'2px'});

	// Remove the white background DIV
	iwBackground.children(':nth-child(4)').css({'background' : 'rgb(255,255,255)'}).css({'border-radius':'2px'});
